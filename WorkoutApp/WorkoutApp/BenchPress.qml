            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            if (listView.model.get(listView.currentIndex).id < 1) {
                                ...
                                // edit mode
                                input.setlistview()
                                JS.dbUpdateBench(listView.model.get(listView.currentIndex).currentWeight,
                    ...
                    Button {
                        ...
                        onClicked: {
                            JS.dbDeleteRowBench(listView.model.get(listView.currentIndex).id)
