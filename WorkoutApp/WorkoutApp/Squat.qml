            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            if (listView.model.get(listView.currentIndex).id < 1) {
                                ...
                                // edit mode
                                input.setlistview()
                                JS.dbUpdateSquat(listView.model.get(listView.currentIndex).currentWeight,
                    ...
                    Button {
                        ...
                        onClicked: {
                            JS.dbDeleteRowSquat(listView.model.get(listView.currentIndex).id)
