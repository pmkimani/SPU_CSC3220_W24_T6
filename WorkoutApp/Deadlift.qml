            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            if (listView.model.get(listView.currentIndex).id < 1) {
                                ...
                                // edit mode
                                input.setlistview()
                                JS.dbUpdateDeadlift(listView.model.get(listView.currentIndex).currentWeight,
                                            listView.model.get(listView.currentIndex).goalWeight,
                                            listView.model.get(listView.currentIndex).goalReps,
                    ...
                    Button {
                        ...
                        enabled: !window.creatingNewEntry && !window.editingEntry && listView.currentIndex !== -1
                        onClicked: {
                            input.editrec(listView.model.get(listView.currentIndex).currentWeight,
                                          listView.model.get(listView.currentIndex).goalWeight,
                                          listView.model.get(listView.currentIndex).goalReps,
                                          listView.model.get(listView.currentIndex).id)
                    ...
                    Button {
                        ...
                        onClicked: {
                            JS.dbDeleteRowDeadlift(listView.model.get(listView.currentIndex).id)
                ...
                ListView {
                    ...
                    header: Component {
                        RowLayout {
                            ...
                            Repeater {
                                model: [qsTr("Current Weight"), qsTr("Goal Reps"), qsTr("Goal Reps")]
                                delegate: Label {
